...
public class MahasiswaAdapter extends RecyclerView.Adapter<MahasiswaAdapter.MahasiswaViewHolder>{
    ...
    public void onBindViewHolder(MahasiswaViewHolder holder, int
            position) {
        holder.txtNama.setText(dataList.get(position).getNama()); holder.txtNim.setText(dataList.get(position).getNim()); holder.txtAngkatan.setText(dataList.get(position).getAngkatan());
    }
    @Override
    ...
    public class MahasiswaViewHolder extends
        ...
        public MahasiswaViewHolder(View itemView) {
            super(itemView); txtNama = (TextView)
